  ...
  <div style="height: 100vh" class="container-fluid">
    <header>
      ...
      <p class="text-center">
        ...
        <b>Mobile: </b>9768010310 | <b>E-mail id:</b> <a href="mailto:dk.amittraders@gmail.com"
          style="text-decoration: none;color: black;">dk.amittraders@gmail.com</a>
      </p>
    </header>
    <main class="table-responsive">
      <table class="table table-bordered">
        <thead>
          <tr>
            <th colspan="3">
              <h3 class="h4-responsive text-center"><b>TAX INVOICE</b></h3>
            </th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td colspan="2"><b>Invoice No:</b>
              <?php echo $invoiceNo; ?>
            </td>
            <td><b>Invoice Date: </b>
          ...
          <tr>
            ...
            <td><b>Date of Supply: </b>
              <?php echo $dateOfSupply; ?>
            </td>
          </tr>
        </tbody>
      </table>
      <table class="table table-bordered">
        ...
        <tr>
          <td><b>Name of Company: </b>
            <?php echo $nameOfCompany; ?>
          <td><b>Name of Company: </b>
            <?php echo $nameOfCompany; ?>
        </tr>
        <tr>
          <td><b>Address of Company: </b>
            <?php echo $addressOfCompany; ?>
          <td><b>Address of Company: </b>
            <?php echo $addressOfCompany; ?>
        </tr>
        <tr>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td rowspan="5" colspan="5">
            <script type="text/javascript">document.write(numberToEnglish(total), ' Only.')</script>
          </td>
      ...
      <table class="table table-bordered">
        <tbody>
          <tr>
            <td colspan="2">
              <h5 class="h5-responsive text-center"><b>BANK DETAILS</b></h5>
            </td>
            <td colspan="2">
              <h5 class="h5-responsive text-center"><b>AUTHORISED SIGNATORY</b></h5>
            </td>
          </tr>
          <tr>
