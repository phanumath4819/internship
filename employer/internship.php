    ...
    if (isset($_GET['add']) || isset($_GET['edit'])) {
          ...
          <div class="card">
            <div class="card-header card-title text-center">
              <h4 class="text-center">
                <?= ((isset($_GET['edit'])) ? 'EDIT' : 'ADD'); ?> INTERNSHIP DETAILS
              </h4>
            </div>
            <div class="card-body">
              <!-- Form -->
              <form class="text-center" style="color: #757575;"
                action="internship.php?<?= ((isset($_GET['edit'])) ? 'edit=' . $edit_id : 'add=1'); ?>" method="post"
                ...
                <!-- Name of Company -->
                <div class="md-form">
                  <input type="text" id="nameOfCompany" name="nameOfCompany" class="form-control" value="<?= $emp_name; ?>"
                    required>
                  <label for="nameOfCompany">Name of Company</label>
                </div>
                <!-- About Company -->
                <div class="md-form">
                  <textarea id="aboutCompany" name="aboutCompany" class="md-textarea form-control" value="<?= $emp_about; ?>"
                    rows="3" required></textarea>
                  <label for="aboutCompany">About Company</label>
                </div>
                <!-- About Internship -->
                <div class="md-form">
                  <textarea id="aboutInternship" name="aboutInternship" class="md-textarea form-control"
                    value="<?= $aboutInternship; ?>" rows="3" required></textarea>
                ...
                <!-- Price -->
                <div class="md-form">
                  <input type="number" id="positions" name="positions" class="form-control" value="<?= $positions; ?>"
                    required>
                  <label for="positions">No. of Positions Available</label>
                </div>
                <!--Material textarea-->
                <div class="md-form">
                  <textarea id="whoCanApply" name="whoCanApply" class="md-textarea form-control" value="<?= $whoCanApply; ?>"
                    rows="3" required></textarea>
                  <label for="whoCanApply">Who Can Apply</label>
                </div>

                <div class="card-footer">
                  <button class="btn btn-black waves-effect z-depth-0" type="submit" name="add">
                    <?= ((isset($_GET['edit'])) ? 'EDIT' : 'ADD'); ?> INTERNSHIPS
                  </button>
                </div>
              </form>
            </div>
      ...
      ?>
        <div class="container-fluid table-responsive">
          <a href="internship.php?add=1" class="btn text-white" style="background-color: #1c2a48" id="add-product-btn">Add
            Internship</a>
