  ...
  <div class="card">
    ...
    <div class="card-footer">
      ...
      if (!isset($_SESSION['username'])) {
        ...
        $sqlcus = "SELECT * FROM customers WHERE username = '$username'";
        ...
        if (isset($cus_app_id) == $cus_id) {
          ...
          ?>
          <a href="application.php?apply=<?= $id; ?>" class="btn btn-success btn-black waves-effect z-depth-0"
            name="apply">Apply Now</a>
        <?php }
      } ?>
    </div>
  </div>
