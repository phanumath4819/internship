					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="md-form form-sm"> <i class="fa fa-envelope prefix"></i>
								<input type="username" id="username" class="form-control form-control-sm" name="email">
						...
						<div class="text-center mt-4">
							<button class="btn btn-default" type="submit" name="submit">Submit <i
...
if (isset($_POST['submit'])) {
	...
	$insertUser = "INSERT INTO admin (`ip`,`fullname`,`username`,`password`,`address1`,`address2`,`city`,`state`,`zipcode`,`phone`,`country`) VALUES ('$ip','$fullname','$email','$password','$address1','$address2','$city','$state','$zipcode','$phone','$country')";
	$db->query($insertUser);
