			...
			<div class="container-fluid">
				<form class="p-3 grey-text" method="post" action="" enctype="multipart/form-data">
					<div class="md-form form-sm"> <i class="fa fa-lock prefix"></i>
						<input type="password" id="password" class="form-control form-control-sm" name="current"
							required>
					...
					<div class="md-form form-sm"> <i class="fa fa-lock prefix"></i>
						<input type="password" id="password" class="form-control form-control-sm" name="confirm"
							required>
						<label for="password">Confirm Password</label>
					</div>
					<div class="text-center mt-4">
						<button class="btn btn-default" type="submit" name="update_password">Change Password <i
...
if (isset($_POST['update_password'])) {
	...
	$sqlPass = "SELECT * FROM customers WHERE password = '$current_password' AND username = '$username'";
