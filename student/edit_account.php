				...
				<form class="p-3 grey-text" method="post" action="" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-6">
							...
							<div class="md-form form-sm"> <i class="fa fa-envelope prefix"></i>
								<input type="username" id="username" class="form-control form-control-sm"
									name="username" value="<?php echo $cus_username; ?>">
						...
						<div class="text-center mt-4">
							<button class="btn btn-default" type="submit" name="update">Update <i
...
if (isset($_POST['update'])) {
	...
	$updateCus = "UPDATE customers SET fullname = '$fullname', username = '$username', address1 = '$address1', address2 = '$address2', city = '$city', state = '$state', zipcode = '$zipcode', phone = '$phone', country = '$country' WHERE id = '$customer_id'";
